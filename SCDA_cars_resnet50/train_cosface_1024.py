...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar  2 15:48:59 2021
...
# -*- coding: utf-8 -*-
"""
Created on Wed Feb 24 23:35:59 2021
...
#from about_msloss.arcface import Criterion
...
SparseCircle = AddMarginProduct(in_features=1024,out_features=98, s=50, m=0.50).cuda()   #or s=40  4000
        ...
        # scheduler.step()
            if idx in [3800,3999,4499,4999,5999,6999,7999]:
                torch.save({'model': model.state_dict(),
                            ...
                            }, args.savedir + '/checkpoint_' + str(idx) + "_" + str(losses.item())[0:6] + '_cos.pth',_use_new_zipfile_serialization=False)
